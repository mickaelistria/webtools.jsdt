...
public abstract class OperatorExpression extends Expression implements OperatorIds, IOperatorExpression {
	...
	public static final String generateTableTestCase(){
		...
		*/
		...
		s	.append("\tpublic static void binaryOperationTablesTestCase(){\n") //$NON-NLS-1$
		
			.append("\t\t//TC test : all binary operation (described in tables)\n") //$NON-NLS-1$
			.append("\t\t//method automatically generated by\n") //$NON-NLS-1$
			.append("\t\t//org.eclipse.wst.jsdt.internal.compiler.ast.OperatorExpression.generateTableTestCase();\n") //$NON-NLS-1$
			
			.append("\t\tString str0;\t String str\t= ").append(decode.constant(T_JavaLangString)).append(";\n") //$NON-NLS-1$ //$NON-NLS-2$
			.append("\t\tint i0;\t int i\t= ").append(decode.constant(T_int)).append(";\n") //$NON-NLS-1$ //$NON-NLS-2$
			.append("\t\tboolean z0;\t boolean z\t= ").append(decode.constant(T_boolean)).append(";\n") //$NON-NLS-1$ //$NON-NLS-2$
			.append("\t\tchar c0; \t char  c\t= ").append(decode.constant(T_char)).append(";\n") //$NON-NLS-1$ //$NON-NLS-2$
			.append("\t\tfloat f0; \t float f\t= ").append(decode.constant(T_float)).append(";\n") //$NON-NLS-1$ //$NON-NLS-2$
			.append("\t\tshort s0; \t short s\t= ").append(decode.constant(T_short)).append(";\n") //$NON-NLS-1$ //$NON-NLS-2$
			.append("\t\tlong l0; \t long l\t= ").append(decode.constant(T_long)).append(";\n") //$NON-NLS-1$ //$NON-NLS-2$
			.append("\t\tObject obj0; \t Object obj\t= ").append(decode.constant(T_JavaLangObject)).append(";\n") //$NON-NLS-1$ //$NON-NLS-2$
			.append("\n"); //$NON-NLS-1$
		...
		{	int operator = operators[i];
			...
			{	int result = (OperatorSignatures[operator][(left<<4)+right]) & 0x0000F;
				...
				{	s.append("\t\t").append(decode.type(result)).append("0 = ").append(decode.type(left)); //$NON-NLS-1$ //$NON-NLS-2$
					s.append(" ").append(decode.operator(operator)).append(" ").append(decode.type(right)).append(";\n"); //$NON-NLS-2$ //$NON-NLS-1$ //$NON-NLS-3$
					...
					s.append(begin)	.append(decode.type(result)). append("0").append(test) //$NON-NLS-1$
									.append(decode.constant(left)).append(" ") //$NON-NLS-1$
									.append(decode.operator(operator)).append(" ") //$NON-NLS-1$
									.append(decode.constant(right)).append("))\n"); //$NON-NLS-1$
					s.append("\t\t\tSystem.out.println(").append(++error).append(");\n"); //$NON-NLS-1$ //$NON-NLS-2$
