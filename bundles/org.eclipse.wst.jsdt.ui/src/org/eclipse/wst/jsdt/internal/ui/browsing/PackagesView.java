...
public class PackagesView extends JavaBrowsingPart{
	...
	protected boolean isValidInput(Object element) {
		if (element instanceof IJavaScriptProject || (element instanceof IPackageFragmentRoot && ! ((IJavaScriptElement)element).getElementName().equals(IPackageFragmentRoot.DEFAULT_PACKAGEROOT_PATH)))
			try {
